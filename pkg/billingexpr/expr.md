...
**Files**: `service/log_info_generate.go`, `web/src/features/usage-logs/lib/format.ts`, `web/src/features/pricing/components/dynamic-pricing-breakdown.tsx`
...
| Shared frontend parsing | `web/src/features/pricing/lib/billing-expr.ts`, `web/src/features/pricing/lib/tier-expr.ts` |
| Model detail | `web/src/features/pricing/components/dynamic-pricing-breakdown.tsx` |
| Log display | `web/src/features/usage-logs/lib/format.ts`, `web/src/features/usage-logs/components/` |
