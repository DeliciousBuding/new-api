...
func InitOptionMap() {
	...
	common.OptionMap["HomePageStyle"] = "spark"
	...
	common.OptionMap["MaxUpstreamAttempts"] = strconv.Itoa(common.MaxUpstreamAttempts)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" || key == "InvitationCodeRequired" {
	...
	case "MaxUpstreamAttempts":
		common.MaxUpstreamAttempts, _ = strconv.Atoi(value)
