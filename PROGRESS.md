...
- **主线 main**：含 audit-2026-08 全部修复批次（#65/#62/#63/#61/#60/#66/#67 已合，详见 `docs/FORK_SURFACE.md` §4d）
...
- **UPSTREAM_BASE**：`823e26304`（#61 已 bump，落后官方 0）
- **open PR / issue**：0 / 0
...
- **`docs/BACKLOG.md`** — 7 个已归档设计 debt，按优先级分 3 组：
  ...
  3. Ops：#51 medium（runner 注销，workflow 已停用）
- **fork 治理 SSOT**：`docs/FORK_SURFACE.md`（§0 状态、§4d 合流、§6 风险）
