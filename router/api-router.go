...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.PUT("/vision_relay", controller.UpdateVisionRelayOptions)
		...
		invitationCodeRoute.Use(middleware.AdminAuth())
		{
			...
			invitationCodeRoute.DELETE("/invalid", controller.DeleteInvalidInvitationCode)
		...
		logRoute.POST("/stat/cache/batch", middleware.UserAuth(), controller.GetLogsCacheStatBatch)
		logRoute.POST("/stat/cache/daily", middleware.UserAuth(), controller.GetLogsCacheStatDaily)
