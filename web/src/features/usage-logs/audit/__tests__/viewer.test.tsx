...
it('mobile access history keeps pagination visible and puts result filters in a drawer', async () => {
  ...
  try {
    ...
    // The filter popup portals outside the modal drawer, where Base UI keeps
    // pointer-events disabled under jsdom, so dispatch the click directly. The
    // selection contract below is unchanged. Upstream v1.0.0-rc.34 fails this
    // step too with its own lockfile.
