  ...
  test('getStatus validates a healthy status payload', async () => {
    responseData = {
      ...
      data: {
        ...
        PGLatencyMS: 1,
        ContentGapsTotal: 0,
        ContentRetriedTotal: 0,
        ContentDroppedTotal: 0,
        RecentVolume: 1,
        ...
        RetentionFailures: 0,
        RetentionTurnsPending: 0,
        RetentionSessionsPending: 0,
        RetentionObjectsPending: 0,
        RetentionBacklogAge: 0,
        RetentionBacklogTruncated: false,
      },
    }
